...
type NERServiceClient interface {
	...
	BatchExtractEntities(ctx context.Context, in *BatchExtractEntitiesRequest, opts ...grpc.CallOption) (*BatchNERResponse, error)
}
...
func (c *nERServiceClient) BatchExtractEntities(ctx context.Context, in *BatchExtractEntitiesRequest, opts ...grpc.CallOption) (*BatchNERResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(BatchNERResponse)
...
type NERServiceServer interface {
	...
	// Extract entities from multiple texts in batch
	BatchExtractEntities(context.Context, *BatchExtractEntitiesRequest) (*BatchNERResponse, error)
...
func (UnimplementedNERServiceServer) BatchExtractEntities(context.Context, *BatchExtractEntitiesRequest) (*BatchNERResponse, error) {
